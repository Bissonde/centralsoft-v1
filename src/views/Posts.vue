<template>
                    ...
                    mdi-weather-night
                      ...
                      mdi-plus-circle
                        ...
                        <v-sheet class="pa-4 pb-10" elevation="12" height="auto" width="100%">
                            ...
                            <v-row>
                                <v-col cols="9">
                                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1">
                                        <v-icon>mdi-chart-bubble</v-icon>&nbsp;Dashboard
                                    </h1>
                                        ...
                                        <v-slide-group-item v-for="n in tabMenus" :key="n" v-slot="{ isSelected, toggle }">
                                            <v-card width="250" class="overflow-hidden pa-l ma-2 rounded-sm" elevation="3"
                                                ...
                                                <v-btn variant="text" class="float-sm-right"
                                                    @click.stop="openDialog(n); editModal = !editModal;">
                        ...
                        <v-sheet class="pa-4" elevation="12" height="auto" width="100%">
                            <v-row cols="12" sm="12" md="12" lg="12">
                                <v-col cols="9">
                                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1">
                                        <v-icon>mdi-chart-bar</v-icon>&nbsp;Gráficos</h1>
                                    <i class="float-sm-left text-body-2"><v-icon icon="mdi-clock-fast"></v-icon>&nbsp;Última
                                        actualização:
                                        22/05/2023</i>
                                </v-col>
                                            ...
                                            <v-row>
                                                <v-col cols="8">
                                                    <h6 class=" text-subtitle-2 font-weight-bold mb-1">
                                                        <v-icon>mdi-chart-pie</v-icon>&nbsp;Volume
                                                    </h6>
                                                </v-col>
                                                <v-col cols="4">
                                            ...
                                            <v-row cols="10" sm="3" md="3" lg="3">
                                                <v-sheet cols="3" class="mx-auto mb-0 ma-0 pa-6" height="auto" width="98%">
                                                    ...
                                                    <v-table density="compact"
                                                        style="width:100%; max-height:150px; overflow-y:scroll;">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-left">
                                                                    Name
                                    ...
                                    <v-sheet class="d-flex flex-wrap">
                                            ...
                                            <v-row>
                                                <v-col cols="8">
                                                    <h6 class="text-body-2 font-weight-bold mb-1">
                                                        <v-icon>mdi-play-speed</v-icon>&nbsp;Volume
                                                    </h6>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-btn variant="text" class="float-sm-right text-caption"
                                        ...
                                        <v-sheet class="flex-1-1 ma-1 pa-1" style="max-width:500px;">
                                            <v-row>
                                                <v-col cols="8">
                                                    <h6 class="text-body-2 font-weight-bold mb-1">
                                                        <v-icon>mdi-poll</v-icon>&nbsp;Volume</h6>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-btn variant="text" class="float-sm-right text-caption"
                                                        @click="openDialog(n); viewModal = !viewModal">
                                    ...
                                    <v-sheet class="d-flex flex-wrap">
                                        <v-sheet class="flex-1-1 ma-1 pa-1">
                                            <v-row>
                                                <v-col cols="8">
                                                    <h6 class="text-body-2 font-weight-bold mb-1">
                                                        <v-icon>mdi-speedometer</v-icon>&nbsp;Volume
                                                    </h6>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-btn variant="text" class="float-sm-right text-caption"
                    ...
                    style="background-color: #ccc; height:180px">4</v-col>
                        ...
                        <v-sheet class="pa-4" elevation="12" height="auto" width="100%">
                            <v-row>
                                <v-col cols="9">
                                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1">
                                        <v-icon>mdi-finance</v-icon>&nbsp;Estatísticas
                                    </h1>
                                    <i class="float-sm-left text-body-2"><v-icon icon="mdi-clock-fast"></v-icon>&nbsp;Última
                                        actualização:
                                        22/05/2023</i>
          ...
          <v-img cover src="https://media.istockphoto.com/id/1311598658/photo/businessman-trading-online-stock-market-on-teblet-screen-digital-investment-concept.jpg?b=1&s=612x612&w=0&k=20&c=bpQMsH07ziELXla0SZJt84-w0JkxsVXs05c7T2Iygks="></v-img>
                        ...
                        <v-sheet class="pa-4 pb-10" elevation="12" height="auto" width="100%">
                            <v-row>
                                <v-col cols="9">
                                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1">
                                        <v-icon>mdi-history</v-icon>&nbsp;Recentes</h1>
                                    <i class="float-sm-left text-body-2"><v-icon icon="mdi-clock-fast"></v-icon>&nbsp;Última
                                        actualização:
                                        22/052023</i>
                                </v-col>
    ...
    this.modName.text }}</v-toolbar-title>
                                            ...
                                            <v-btn role="link" @click="handleClick(); isEditing = !isEditing"
                                                class="activateBtn"
                                            ...
                                            <template v-if="$vuetify.display.smAndUp">
                                                <v-divider class="mx-3 align-self-center" length="24" thickness="2"
                                                    vertical></v-divider>
                                        ...
                                        <v-alert type="success" title="Sucesso" v-if="alert == true"
                                            transition="slide-y-transition" border="start" variant="tonal" v-model="alert"
                                            closable text="As suas alterações foram gravadas com sucesso!"></v-alert>

                                        <v-card-text v-if="this.modName == 'Contacts'">
          ...
          <span class="text-h5">User Profile</span>
                                                        ...
                                                        <v-row>
                                                            <v-col cols="12" sm="6" md="4" class="pa-0">
                                                                <v-form fast-fail @submit.prevent>
                                                                    <v-text-field label="Primeiro nome*" name="fname"
                                                                        v-validate="required" :disabled="!isEditing"
                                                                        v-model="firstName" :counter="10"
                                                            ...
                                                            <v-col cols="12" sm="6" md="4" class="pa-0">
                                                                <v-text-field :disabled="!isEditing" v-model="lastName"
                                                            ...
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-text-field :disabled="!isEditing" label="Telefone*"
                                                                    type="telephone" prepend-inner-icon="mdi-phone"
                                                                    required></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="5" md="6" class="pa-0 ml-0">
                                                                <v-text-field :disabled="!isEditing" label="SMS*"
                                                                    type="telephone" prepend-inner-icon="mdi-message-text"
                                                                    required></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                            ...
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-select :disabled="!isEditing"
                                                                    ...
                                                                    label="Idade*" prepend-inner-icon="mdi-numeric-7"
                                                                    required></v-select>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                            ...
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-autocomplete :disabled="!isEditing"
                                                                    :items="['Marketing', 'Autenticação', 'Cobrança']"
                                                                    label="Campanha" prepend-inner-icon="mdi-forum"
                                                                    multiple></v-autocomplete>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-autocomplete :disabled="!isEditing"
                                                            ...
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-autocomplete :disabled="!isEditing"
                                                                    :items="['Cliente', 'Empresa', 'Interno']" label="Grupo"
                                                                    prepend-inner-icon="mdi-account-multiple"
                                                                    multiple></v-autocomplete>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-autocomplete :disabled="!isEditing"
                                                                    :items="['Marketing', 'Autentificação', 'Cobrança']"
                                                                    label="Flex" prepend-inner-icon="mdi-shuffle"
                                                                    multiple></v-autocomplete>
                                                            </v-col>
                                                        </v-row>
                                                        <!-- </v-container> -->
                                        ...
                                        <v-card-text v-if="this.modName == 'Groups'">
                                                            ...
                                                            <v-row>
                                                                <v-col cols="12" sm="12" md="12" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing"
                                                                        label="Nome do Grupo*" v-model="firstName"
                                                                        :counter="10" :rules="firstNameRules"
                                                                        prepend-inner-icon="mdi-account-multiple"
                                                                        required></v-text-field>
                                                                </v-col>
                                                                <v-col cols="12" sm="12" md="12" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing" label="Descrição"
                                                                        v-model="lastName" :counter="10"
                                                                        :rules="lastNameRules"
                                                                ...
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        ...
                                                                        label="Departamento" prepend-inner-icon="mdi-domain"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Interno', 'Externo', 'Admin']"
                                                                        label="Tipo de Conta"
                                                                ...
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Convidado', 'Administrador']"
                                                                        label="Domínio" prepend-inner-icon="mdi-security"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['English', 'Português', 'François']"
                                                                        label="Linguagem" prepend-inner-icon="mdi-translate"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Painel', 'Windows']"
                                                                ...
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Marketing', 'Autentificação', 'Cobrança']"
                                                                        label="Campanha"
                                                                        prepend-inner-icon="mdi-message-star-outline"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                        ...
                                        <v-card-text v-if="this.modName == 'Campaigns'">
          ...
          <span class="text-h5">User Profile</span>
                                                        ...
                                                        <v-card-text>
                                                            ...
                                                            <v-row>
                                                                <v-col cols="12" sm="12" md="12" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing"
                                                                        label="Título da Campanha" v-model="firstName"
                                                                        :counter="10" :rules="firstNameRules"
                                                                ...
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing" label="Data*"
                                                                        type="date" prepend-inner-icon="mdi-calendar"
                                                                        required></v-text-field>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing" label="Hora"
                                                                        type="time" prepend-inner-icon="mdi-clock-outline"
                                                                        hint="example of helper text only on focus"></v-text-field>
                                                                </v-col>
                                                                <v-col cols="12" sm="12" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Skiing', 'Ice hockey', 'Soccer', 'Basketball', 'Hockey', 'Reading', 'Writing', 'Coding', 'Basejump']"
                                                                        label="SMS"
                                                                        prepend-inner-icon="mdi-message-settings-outline"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="12" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                ...
                                                                <v-col cols="12" sm="12" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['Skiing', 'Ice hockey', 'Soccer', 'Basketball', 'Hockey', 'Reading', 'Writing', 'Coding', 'Basejump']"
                                                                        label="Telefone" prepend-inner-icon="mdi-phone"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                            </v-row>
                                                            <!-- </v-container> -->
                                        ...
                                        <v-card-text
                                            v-if="this.modName == 'Messages' | this.modName == 'Chamadas' | this.modName == 'WhatsApp' | this.modName == 'E-mail'">
                                                    ...
                                                    <v-card>
                                                        ...
                                                        <v-card-text>
                                                            ...
                                                            <v-row>
                                                                <v-col cols="12" sm="12" class="pa-0">
                                                                    <v-autocomplete :disabled="!isEditing"
                                                                        :items="['SMS', 'Telefone', 'WhatsApp', 'E-mail']"
                                                                        label="Categoria" prepend-inner-icon="mdi-cube-send"
                                                                        multiple></v-autocomplete>
                                                                </v-col>
                                                                <v-col cols="12" sm="12" md="12" class="pa-0">
                                                                    <v-text-field :disabled="!isEditing" label="Título"
                                                                        v-model="firstName" :counter="10"
                                                                        :rules="firstNameRules"
                                                                        hint="example of helper text only on focus"
                                                                        prepend-inner-icon="mdi-format-title"></v-text-field>
                                                                ...
                                                                <v-col cols="12" sm="12" md="12" class="pa-0">
                                                                    <v-textarea :disabled="!isEditing" label="Mensagem*"
                                                                        v-model="lastName" :counter="10"
                                                                        :rules="lastNameRules"
                                        ...
                                        <v-card-text v-if="this.modName == 'Contas'">
          ...
          <span class="text-h5">User Profile</span>
                                                    ...
                                                    <v-card-text>
                                                        ...
                                                        <v-row>
                                                            ...
                                                            <v-col cols="12" sm="6" md="4" class="pa-0">
                                                                <v-text-field :disabled="!isEditing" label="Último nome*"
                                                                    v-model="lastName" :rules="lastNameRules"
                                                                    hint="example of persistent helper text" persistent-hint
                                                                    required></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                            ...
                                                            <v-col cols="12" sm="6" md="6" class="pa-0">
                                                                <v-text-field :disabled="!isEditing" label="Password*"
                                        ...
                                        <v-card-text v-if="this.modName == 'Histórico'">
...
Save
                                        ...
                                        <v-card-text v-if="this.modName == 'Settings'">
    ...
    this.modName.text }}</v-toolbar-title>
                                ...
                                <v-dialog width='750' v-model="alertModal" v-if="alert">
                                    ...
                                    <v-fade-transition hide-on-leave>
                                        <v-card v-if="alertModal" append-icon="$close" class="mx-auto" elevation="16"
                                            width="600" title="Send a receipt">
                                            <template v-slot:append>
                                            ...
                                            <div class="pa-4 text-end">
                                                <v-btn class="text-none" color="medium-emphasis" min-width="92" rounded
                                                    variant="outlined" @click="alertModal = false">
                                                    Close
                                                </v-btn>
                                            </div>
                                        </v-card>
                                ...
                                <v-dialog width='750' v-model="filterModal">
                                    ...
                                    <v-fade-transition hide-on-leave>
                                        <v-card v-if="filterModal" append-icon="$close" class="mx-auto" elevation="16"
                                            width="600" title="Send a receipt">
                                            <template v-slot:append>
                                            ...
                                            <div class="pa-4 text-end">
                                                <v-btn class="text-none" color="medium-emphasis" min-width="92" rounded
                                                    variant="outlined" @click="filterModal = false">
                                                    Close
                                                </v-btn>
                                            </div>
                                        </v-card>
        ...
        <v-card-actions>
          ...
          >
            Save
                            ...
                            <v-table style="text-align: left;" density="compact" :elevation="isHovering ? 24 : 14"
                                class="mx-auto pa-1">
                                <thead>
                                    <th>Nome</th>
                                    <th>E-mail</th>
